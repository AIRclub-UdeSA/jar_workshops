...
(`/odom`) y las [transformaciones](https://docs.ros.org/en/humble/Tutorials/Intermediate/Tf2/Tf2-Main.html)
(`/tf`) representan la orientación con un
[cuaternión](https://docs.ros.org/en/humble/Tutorials/Intermediate/Tf2/Quaternion-Fundamentals.html)
